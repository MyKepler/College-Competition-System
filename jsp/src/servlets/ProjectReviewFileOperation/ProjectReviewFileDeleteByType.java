...
@WebServlet("/ProjectReviewFileDeleteByType")
public class ProjectReviewFileDeleteByType extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (StringUtils.isNotBlank(id) && StringUtils.isNotBlank(type)){
            ...
            Integer msg = ProReviewDao.ProjectReviewDeleteByTypeFiles(id,type);
            if(msg<0){
