...
@WebServlet("/ProjectReviewFileDeleteAll")
public class ProjectReviewFileDeleteAll extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (StringUtils.isNotBlank(id)){
            ...
            Integer msg = ProReviewDao.ProjectReviewDeleteAllFiles(id);
            if(msg<0){
