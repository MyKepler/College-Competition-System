...
/**
 * Servlet implementation class ReProInfoState
 */
@WebServlet("/ReProInfoState")
public class ReProInfoState extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReProInfoState() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isReState = proInfoDao.reProInfoState(proId, state);
