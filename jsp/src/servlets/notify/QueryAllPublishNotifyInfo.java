...
@WebServlet("/QueryAllPublishNotifyInfo")
public class QueryAllPublishNotifyInfo extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (StringUtils.isNotBlank(pageNum) && StringUtils.isNotBlank(pageSize)){
            List<NotifyObject> list = NotifyDao.queryAllPublishNotifyInfo(pageNum,pageSize);
            if (list!=null)
