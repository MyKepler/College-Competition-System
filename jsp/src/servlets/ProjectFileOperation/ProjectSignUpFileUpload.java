...
@WebServlet("/ProjectSignUpFileUpload")
public class ProjectSignUpFileUpload extends HttpServlet {
            ...
            while (iter.hasNext()) {
                ...
                if (!formitem.isFormField()) { // 忽略不是上传文件的表单域
                    ...
                    try {
                        ...
                        i=projectDao.ProjectSignUpUploadFiles(id,time,state,filepath,type,exname);
