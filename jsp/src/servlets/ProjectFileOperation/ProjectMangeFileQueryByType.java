...
//项目管理中特点id和type查询全部文件
@WebServlet("/ProjectMangeFileQueryByType")
public class ProjectMangeFileQueryByType extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(StringUtils.isNotBlank(id) && StringUtils.isNotBlank(type)){
            ...
            if(list!=null){
                result = new ResponseObject(200,"查询文件成功",list);
            }else
                result = new ResponseObject(500,"查询文件失败");
        }else
