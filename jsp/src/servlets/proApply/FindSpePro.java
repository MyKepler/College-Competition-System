...
/**
 * Servlet implementation class FindSpePro
 */
@WebServlet("/FindSpePro")
public class FindSpePro extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(StringUtils.isNotBlank(proId)) {
			pst = proDao.findSpePro(proId);
			if(pst != null) {
				result = new  ResponseObject(200,"成功返回学生个人信息!",pst);
			}
			else {
