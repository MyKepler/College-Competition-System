...
public class EndProjectImpl extends DBUtil implements EndProject{
	...
	public int getCount() {
		...
		try {
            ...
            String sqlForAllPro = "select count(*) from project where project_status = '结题' and project_state = '可用'";
	...
	@Override
	public List<ProStuTeaAndRev> findEndPro(String pageNum, String pageSize) {
		Connection conn=null;
		Statement statement = null;
		ResultSet resultSet = null;
		...
		try {
            ...
            String sqlForAllMidPro = "select * from project where project_status = '结题' and project_state = '可用' limit "+(numer-1)*size+","+size+";";
            ...
            if(resultSet != null) {
            		...
            		while(resultSet.next()) {
    					...
    					//查询所有符合条件的文件
    					String sqlForQueryFiles = "SELECT * FROM project_files WHERE  file_type = '结题' and project_id = '"+id+"';";
	...
	@Override
	public ProStuTeaAndRev findSpeEndPro(String proId) {
		Connection conn=null;
		Statement statement = null;
		ResultSet resultSet = null;
		Statement statementStu=null;
		...
		try {
            ...
            statementFile = conn.createStatement();
            // 项目
            String sqlPro = "select * from project where project_id = '" +  proId + "'and project_status='结题';";
	...
	@Override
	public int updateEndPro(ProjectObject proObj) {
		Connection conn=null;
		Statement statement = null;
		ResultSet resultSet = null;
	...
	@Override
	public boolean delEndPro(String proId) {
		// TODO 自动生成的方法存根
		return false;
	}
/*--------------------------------------------------教师端------------------------------------------------------*/
	...
	@Override
	public List<ProStuTeaAndRev> findEndProByTea(String pageNum, String pageSize, String userId) {
		...
		try {
            ...
            statement = conn.createStatement();
            statementFile = conn.createStatement();
            String sqlForAllMidPro = "select * from project where project_status = '结题' and project_state = '可用' "
	...
	public int getCount(String userId) {
		...
		try {
			conn=getConn();
            statement = conn.createStatement();
            String sqlForAllPro = "select count(*) from project left join project_student on project.project_id=project_student.project_id where project_status='结题' and is_in_service='可用' and user_id='"+userId+"';";
            System.out.println(sqlForAllPro);
            resultSet = statement.executeQuery(sqlForAllPro);
            if(resultSet.next()) {
            		System.out.println(resultSet.getInt(1)+"");
	...
	@Override
	public List<ProStuTeaAndRev> findAllStuEndPro(String pageNum, String pageSize,String userId) {
		Connection conn=null;
		Statement statement = null;
		ResultSet resultSet = null;
		Statement statementStu=null;
		...
		try {
            ...
            statement = conn.createStatement();
            statementFile = conn.createStatement();
            String sql = "select * from project left join project_student on project.project_id=project_student.project_id where project_status='结题' and is_in_service='可用' and user_id='"+userId+"' limit "+(numer-1)*size+","+size+";";
